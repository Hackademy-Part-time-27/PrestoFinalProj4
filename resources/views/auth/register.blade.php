                ...
                <div class="col-md-6 mx-auto mt-4">
                    ...
                    <div class="mt-5 ">
                        <form method="POST" action="/register">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label fs-6" for="name">{{__('ui.register_name_text') }}</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label fs-6" for="password_confirmation">{{__('ui.register_password_confirmation') }} </label>
