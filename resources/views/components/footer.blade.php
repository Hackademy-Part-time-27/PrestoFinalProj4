<!-- Footer -->
<footer style="background-color: #343a40; color: #f8f9fa; padding: 60px 20px; text-align: center; position: relative;">
    <!-- Wave Background -->
    <div style="position: absolute; top: -50px; left: 0; width: 100%; overflow: hidden; line-height: 0;">
