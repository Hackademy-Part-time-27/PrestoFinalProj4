<nav class="navbar navbar-expand-xl border-bttm nav-size" id="nav">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-between " id="navbarNavDropdown">
        ...
        <ul class="navbar-nav fs-4 align-items-center align-content-center">
            ...
            <li class="nav-item dropdown me-4">
                ...
                {{__('ui.navbar_category') }}
                    ...
                    <ul class="dropdown-menu dropdown-menu-end uppercased bg-drop m-0 px-3 fs-5">
                        ...
                        <li  class="@if($key !== (count($categories)-1))border-bttm @endif fit-content "><a class="dropdown-element" href="{{ route('announcements.category-filter', $category ) }}">{{ $category->name }}</a></li>
                        @endforeach
                    </ul>
            </li>   
        ...
        <ul class="navbar-nav d-flex justify-content-start align-items-center fs-4 ">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle hover" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end position uppercased bg-drop m-0 px-3 fs-5">
            ...
            @endauth
            <form action="{{ route('announcements.search') }}" method="GET" class="d-flex w-75  ms-4 form-width">
